...
% NEXT
DIGing_counter      = zeros(3, Niter+1);
DIGing_counter(2,:) = (0:Niter)*2*comm_time_unit;
DIGing_counter(3,:) = (0:Niter)*1*comp_time_unit;
DIGing_counter(1,:) = DIGing_counter(2,:) + DIGing_counter(3,:);
...
OPTRA_counter      = zeros(3, Niter+1);
OPTRA_counter(2,:) = (0:Niter)*2*K*comm_time_unit;
OPTRA_counter(3,:) = (0:Niter)*1*comp_time_unit;
OPTRA_counter(1,:) = OPTRA_counter(2,:) + OPTRA_counter(3,:);
